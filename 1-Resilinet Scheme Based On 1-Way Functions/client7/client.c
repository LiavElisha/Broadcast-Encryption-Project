...
BYTE GIVEN_KEYS[3][17] = {{216, 144, 179, 87,  146, 147, 142, 165, 24,  127, 40,  117, 211, 94,  12,  13, 0},
                       {29,  213, 105, 46,  213, 65,  170, 77,  161, 49,  79,  80,  48,  21,  235, 250, 0},
                       {233, 76,  145, 183, 255, 172, 41,  234, 132, 238, 244, 191, 141, 204, 42,  192, 0}
};
...
{
	int index = 0;
	updateKeys(GIVEN_KEYS[0], 2, &index);
	updateKeys(GIVEN_KEYS[1], 1, &index);
	updateKeys(GIVEN_KEYS[2], 0, &index);
