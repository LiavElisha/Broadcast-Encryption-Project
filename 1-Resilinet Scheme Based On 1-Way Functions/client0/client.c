...
BYTE GIVEN_KEYS[3][17] = {{208, 249, 110, 90, 183, 142, 130, 163, 101, 36, 27, 122, 156, 64, 96, 252},
                        {210, 179, 59, 219, 18, 56, 203, 143, 104, 182, 202, 220, 226, 20, 81, 107},
...
int createKey(char* key, unsigned char keys[][17])
{
	int index = 0;
	++index;
	updateKeys(GIVEN_KEYS[0], 0, &index);
